...
где:
+ memoryUsage - размер итоговой занимаемой память;
+ userCount - количество пользователей в системе;
+ memoryPerUser - размер занимаемой одним пользователем памяти.  

Получим: 

$$
  memoryUsage = \frac{25 \times 10^6 \times 4.3KB}{1024 \times 1024} = 102.52GB
$$
