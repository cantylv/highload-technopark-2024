...
Рост количества сущностей:
  ...
  + Будет считать, что аудитория сервиса растет постоянно. В 2021 году аудитория сервиса была 20 млн. пользователей.[^10]
...
За 5 лет прирост составил 7 млн. пользователей, тогда коэффициент прироста будет `1.4`. Объем нагрузки на сеть и RPS прямо пропорциональны количеству пользователей, поэтому:
