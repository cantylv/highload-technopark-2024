...
Для балансировки нагрузки на сервера будем использовать GeoDNS. и latency-based DNS балансировку, основаннную на значении latensy сервера, что позволит делать запрос к менее загруженному серверу и не перегружать более загруженный.
