...
За 5 лет прирост составил 7 млн. пользователей, тогда коэффициент прироста будет `1.4`. Объем нагрузки на сеть и RP прямо пропорциональные количеству пользователей, поэтому:
