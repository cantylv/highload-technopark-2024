...
Целевая аудитория сервиса расположениа в России и странах СНГ. Взглянем на карту плотности населения Росиии (на ней обозначены местоположения ЦОДов, CDNов и DNSов):
...
Для балансировки нагрузки на сервера будем использовать GeoDNS и latency-based DNS балансировки. Последняя из упомянутых основана на значении latensy сервера, что позволит делать запрос к менее загруженному серверу и не перегружать более загруженный.
