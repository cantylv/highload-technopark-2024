...
Формула в тексте, например, \( a^2 + b^2 = c^2 \).

$$ 
E = mc^2 
$$

Всего пользователей в сервисе Yandex Music - `25 млн`, тогда занимаемая память под пользователей - `(25 * 1000 * 1000 * 1300) / (1024 * 1024) ~= 31 (GB)`. 
